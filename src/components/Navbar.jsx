...
export default function Navbar(props) {
  ...
  return (
    <>
      <div className='home'>
        <NotificationBar />
        <nav className={`navbar navbar-expand-lg navbar-light bg-white fixed-top shadow-sm ${scrolled ? "scrolled" : ""}`}>
          <div className="container">
            <Link className="navbar-brand fw-bold" to="/">
              <img src={logo} style={{ width: '35px', height: 'auto' }} alt="Trezoar" />
              Trezoar
            </Link>
