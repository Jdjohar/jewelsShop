      ...
      <div className="container pt-5">
        <div className="row">
          ...
          {/* <img src={logo} alt="Logo" style={{ width: '70px', height: 'auto' }} /> */}
            ...
            <a href="#" className="btn btn-outline-light btn-sm me-2"><i className="bi bi-facebook"></i></a>
            <a href="#" className="btn btn-outline-light btn-sm me-2"><i className="bi bi-twitter"></i></a>
            <a href="#" className="btn btn-outline-light btn-sm me-2"><i className="bi bi-instagram"></i></a>
        ...
        <div className="row">
          <div className="col-12 mb-3 text-center">
            <small>&copy; {new Date().getFullYear()} Jewels Shop</small>
          </div>
        </div>
      </div>
    </footer>
